...
class TesteProdutoDAO(unittest.TestCase):
    ...
    def test_apagar_id_existente(self):
        ...
        p = Produto("Biscoito", 4.0, "Frigobar")
        p.id = 7003

        self.dao.salvar(p)

        self.dao.apagar(7003)
    ...
    def test_carregar_id_existente(self):
        ...
        p = Produto("Refrigerante", 9.0, "Frigobar")
        p.id = 7004
